  ...
  <el-card style="width: 500px;">
    <el-form label-width="80px" size="small">
      ...
      <el-form-item label="性别">
        <el-select  v-model="form.gender"  filterable placeholder="请选择" style="margin-left: -180px">
      ...
      <el-form-item label="学院">
        <el-select v-model="form.college" filterable placeholder="请选择" style="margin-left: -180px">
          <el-option
      ...
      <el-form-item label="专业">
        <el-select v-model="form.major" filterable placeholder="请选择" style="margin-left: -180px" @click.native="searchMajor">
          <el-option
              v-for="item in major"
              :key="item.major"
              :label="item.major"
