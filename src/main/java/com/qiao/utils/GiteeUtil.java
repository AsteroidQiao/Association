...
public class GiteeUtil {
     ...
     * 码云私人令牌
     */
    private static final String ACCESS_TOKEN = "45eb1562246552cffee375286e5fef88";

    /**
     * 码云个人空间名
     */
    private static final String OWNER = "AsteroidQiao";

    /**
     * 上传指定仓库
     */
    private static final String REPO = "library-management-system";

    /**
     * 默认上传时指定存放图片路径
     */
    public static final String PATH = "/book-avatar";
